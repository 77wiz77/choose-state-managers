  ...
  return (
    <Box
      ...
      <Box
        ...
        <Typography variant='body1'>
          Redux отлично подходит для масштабирования. Это обуславливается тем,
          что основной механизм работы с состояниями в данной библиотеке – это
          чистые функции. Чистая функция всегда возвращает одинаковый результат
          при том же наборе аргументов в ней. Это делает состояние в Redux
          неизменным (немутабельным) и предсказуемым. Таким образом, вместо
          изменения состояния (мутации состояния), Redux возвращает новое
